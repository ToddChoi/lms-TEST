...
| # | 우선순위 | 영역 | 문제 | 상태 |
|---|---------|------|------|------|
| 1 | 🔴 P1 | 관리자/통계 | `is_published` 잘못된 컬럼명 | 미수정 |
| 2 | 🔴 P1 | 관리자/강좌 | DB Migration 미실행 | 미수정 |
| 3 | 🔴 P1 | 결제 | Stripe 환경변수 미설정 | 미수정 |
| 4 | 🔴 P1 | 결제 | `NEXT_PUBLIC_APP_URL` 미설정 | 미수정 |
| 5 | 🟠 P2 | 공개 헤더 | 네비 링크 4개 404 | 미수정 |
| 6 | 🟠 P2 | 공개 푸터 | 푸터 링크 4개 404 | 미수정 |
| 7 | 🟠 P2 | 로그인 | 비밀번호 찾기 페이지 없음 | 미수정 |
| 8 | 🟠 P2 | 헤더 | 프로필 설정 페이지 없음 | 미수정 |
| 9 | 🟠 P2 | 관리자 사이드바 | 4개 메뉴 404 | 미수정 |
| 10 | 🟠 P2 | 인증 | Supabase URL 미설정 | 미수정 |
